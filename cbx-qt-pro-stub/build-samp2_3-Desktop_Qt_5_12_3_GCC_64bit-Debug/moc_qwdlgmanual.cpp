...
void QWDlgManual::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QWDlgManual *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QWDlgManual::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_QWDlgManual.data,
    qt_meta_data_QWDlgManual,
    qt_static_metacall,
    nullptr,
    nullptr
} };
