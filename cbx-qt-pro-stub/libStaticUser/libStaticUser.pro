#-------------------------------------------------
#
# Project created by QtCreator 2019-09-10T07:33:17
#
#-------------------------------------------------
...
else:unix: LIBS += -L$$PWD/include/ -lmyStaticLib
...
else:unix: PRE_TARGETDEPS += $$PWD/include/libmyStaticLib.a
